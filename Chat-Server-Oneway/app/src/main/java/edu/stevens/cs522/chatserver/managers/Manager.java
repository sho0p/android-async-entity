...
public abstract class Manager<T> {
    ...
    protected void executeQuery(Uri uri,
                                ...
                                String order,
                                IQueryListener<T> listener) {
        QueryBuilder.executeQuery(tag, (Activity) context, uri, projection, selection,
                selectionArgs, order, loaderID, creator, listener);
    }
    ...
    protected void reexecuteQuery(Uri uri,
                                  ...
                                  String order,
                                  IQueryListener<T> listener) {
        QueryBuilder.reexecuteQuery(tag, (Activity) context, uri, projection, selection,
                selectionArgs, order, loaderID, creator, listener);
    }
